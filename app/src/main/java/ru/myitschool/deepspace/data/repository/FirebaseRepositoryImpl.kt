...
import ru.myitschool.deepspace.data.dto.firebase.CommentDto
import ru.myitschool.deepspace.data.dto.firebase.Post
import ru.myitschool.deepspace.data.dto.firebase.SubCommentDto
import ru.myitschool.deepspace.data.dto.firebase.UserDto
        ...
        try {
            ...
            for (value in postItems) {
                if (value::class.java == String::class.java) {
                    ...
                    storage.getReference("posts/$postId/$photoCount").putBytes(byte)
                        .await()
                    val url =
