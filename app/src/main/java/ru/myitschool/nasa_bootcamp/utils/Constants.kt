...
const val STARMAN_GIF_LINK =
    "https://i.pinimg.com/originals/3f/da/af/3fdaaf0000e825ee1477d6e0d30db980.gif"
...
const val errorEmailIsNotVerified =
    "Your email is not verified. Click 'send' button to recieve an email!"
